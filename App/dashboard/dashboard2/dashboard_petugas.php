	  ...
	  <div class="container-fluid pe-3 ps-2">
	    ...
	    <div class="profil d-flex grid gap-0 column-gap-3">
	     ...
	     <div class="line-height pt-1">
	    	<h6 class="fw-semibold">Hi, Petugas</h6>
	    	<p>Rafly Saputra</p>
	     </div>
	    </div>
			...
			<aside class="col-xl-2 gx-0">
				<div class="container-rafly bg-body-secondary py-5">
					<div class="container-fluid d-flex flex-column align-items-center">
						...
						<a href="dashboard_petugas.php?url=profil.php" title="Klik untuk melihat profil"><img src="../img/<?= $datas->gambar; ?>" alt="" width="80px" height="80px" class="rounded-5"></a>
						<div class="online"></div>
						<div class="mypovers">
							online
						</div>
						</div>
						<h5 class="fw-semibold mt-3">Hi, Petugas</h5>
					...
					<div class="container-fluid d-flex flex-column gx-0 mt-5">
						<?php if (isset($_GET['url'])) {
							...
							switch ($file) {
								case 'data_pengguna.php': ?>
									<a href="dashboard_petugas.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Dashboard</a>
									<a href="dashboard_petugas.php?url=data_pengguna.php" class="btn btn-primary border-0 border-bottom border-primary py-4 position-relative prover-dashboard prover-pengguna">Data pengguna</a>
									<a href="dashboard_petugas.php?url=data_buku.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Daftar buku</a>
									<a href="dashboard_petugas.php?url=riwayat.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">History</a>
							<?php break;
								case 'data_buku.php': ?>
									<a href="dashboard_petugas.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Dashboard</a>
									<a href="dashboard_petugas.php?url=data_pengguna.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Data pengguna</a>
									<a href="dashboard_petugas.php?url=data_buku.php" class="btn btn-primary border-0 border-bottom border-primary py-4 position-relative prover-dashboard prover-buku">Daftar buku</a>
									<a href="dashboard_petugas.php?url=riwayat.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">History</a>
							<?php break;
								case 'riwayat.php': ?>
									<a href="dashboard_petugas.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Dashboard</a>
									<a href="dashboard_petugas.php?url=data_pengguna.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Data pengguna</a>
									<a href="dashboard_petugas.php?url=data_buku.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Daftar buku</a>
									<a href="dashboard_petugas.php?url=riwayat.php" class="btn btn-primary border-0 border-bottom border-primary py-4 position-relative prover-dashboard prover-riwayat">History</a>
							<?php break;
								default: ?>
									<a href="dashboard_petugas.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4 prover-dashboard position-relative">Dashboard</a>
									<a href="dashboard_petugas.php?url=data_pengguna.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Data pengguna</a>
									<a href="dashboard_petugas.php?url=data_buku.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Daftar buku</a>
									<a href="dashboard_petugas.php?url=riwayat.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">History</a>
							<?php break;
						...
						<a href="dashboard_petugas.php" class="btn btn-primary border-0 border-bottom border-primary py-4 prover-dashboard position-relative">Dashboard</a>
						<a href="dashboard_petugas.php?url=data_pengguna.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Data pengguna</a>
						<a href="dashboard_petugas.php?url=data_buku.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">Daftar buku</a>
						<a href="dashboard_petugas.php?url=riwayat.php" class="btn btn-outline-primary border-0 border-bottom border-primary py-4">History</a>
					<?php } ?>
						...
						<div class="col-3">
							<div class="card overflow-hidden linear-blue">
								...
								<div class="card-footer text-body-secondary text-center">
							   	 	<a href="dashboard_petugas.php?url=data_pengguna.php" class="text-decoration-none text-secondary fw-semibold font-size d-flex justify-content-center grid gap-0 column-gap-2">Lihat selengkapnya <i class="fa fa-arrow-right icon text-primary"></i></a>
							 	</div>
							</div>
						</div>
						<div class="col-3">
							<div class="card overflow-hidden linear-green">
								...
								<div class="card-footer text-body-secondary text-center">
							   	 	<a href="dashboard_petugas.php?url=data_buku.php" class="text-decoration-none text-secondary fw-semibold font-size d-flex justify-content-center grid gap-0 column-gap-2">Lihat selengkapnya <i class="fa fa-arrow-right icon text-success"></i></a>
							 	</div>
							</div>
						</div>
						<div class="col-3">
